    ...
    stages {
        ...
        stage('Run Tests') {
            steps {
                script {
                    // Запуск тестов
                    bat 'chcp 65001 && C:\\Users\\AU\\AppData\\Local\\Programs\\Python\\Python39\\python.exe -m pytest tests'
                }
            }
        }
        ...
        stage('Run HTML Report') {
            steps {
                script {
                    ...
                    bat 'chcp 65001 && C:\\Users\\AU\\AppData\\Local\\Programs\\Python\\Python39\\python.exe -m pip install pytest-html'
                    // Запуск тестов с генерацией HTML-отчета
                    bat 'chcp 65001 && C:\\Users\\AU\\AppData\\Local\\Programs\\Python\\Python39\\python.exe -m pytest --html=%WORKSPACE%\\PytestArtifacts\\report.html'
                }
            }
        }
